...
$id= mysqli_real_escape_string($con,$_REQUEST['id']??'');
$query="SELECT id_cliente,correo,nombre,apellido,clave,direccion, localidad, telefono from clientes where id_cliente='".$id."'; ";
$res=mysqli_query($con,$query);
                    ...
                    <div class="card-body">
                        <form action="panel.php?modulo=editarCliente" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="localidad" class="form-control" value="<?php echo $row['localidad'] ?>"  required="required" >
                            </div>
