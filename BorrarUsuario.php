                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          <table id="example2" class="table table-bordered table-hover">
                              ...
                              <tbody>
                                  <?php
                                    $query = "SELECT id,mail,nombre from usradmin;  ";
                                    $res = mysqli_query($con, $query);
                                    ...
                                    ?>
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="panel.php?modulo=borrarUsuario&idBorrar=<?php echo $row['id'] ?>" class="text-danger borrar"> <i class="fas fa-trash"></i> </a>
                                          </td>
                                      </tr>
                                  <?php
                                    }
